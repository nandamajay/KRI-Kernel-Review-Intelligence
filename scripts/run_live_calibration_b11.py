"""Track-B.11 Live Review Session — generate real calibration triples via LLM.

Usage (from repo root: kri/):
    python3 scripts/run_live_calibration_b11.py

Output files (written to data/ledger/ sibling of kri/):
    ../data/ledger/calibration_triples_b11.jsonl  — one triple per line
    ../data/ledger/calibration_result_b11.json    — full run summary
"""
...
def pick_mbox_files(n: int = 300) -> list[Path]:
...
def main() -> dict:
    ...
    triples_out = LEDGER_DIR / "calibration_triples_b11.jsonl"
