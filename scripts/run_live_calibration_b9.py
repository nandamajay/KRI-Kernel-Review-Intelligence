...
def main() -> dict:
    ...
    # Persist triples so B10 calibration can consume them without re-running LLM
    triples_out = LEDGER_DIR / "calibration_triples_b9.jsonl"
