...
| 2026-07-17 | 0.5909 | 1.0000 | 0.7429 | fd8ccdf | WP-9.1c sub-commit 2+3: resume signal tightening + location fix. 105 FPs eliminated total. 7 TPs lost (5 spurious + 2 spec-limitation, all documented). Floor ratcheted: precision>=0.55, f1>=0.70. |
